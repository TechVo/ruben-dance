...
class Enrollment_Detail_Page {
	...
	private static function render_notice_from_query(): void {
		...
		$messages = array(
			'manual_enrollment_created'      => array( 'success', __( 'Manual enrollment created. The customer received the confirmation email with payment instructions.', 'ruben-dance' ) ),
			'manual_enrollment_email_failed' => array( 'warning', __( 'Enrollment created, but an enrollment email could not be sent (logged as failed — see the Email Log).', 'ruben-dance' ) ),
